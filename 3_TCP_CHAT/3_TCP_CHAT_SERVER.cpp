...
std::vector<SOCKET> clients; // Отличие от 2 задание - вектор клиентов для чата
...
int __cdecl main(void)
{
    ...
    //// FIONBIO - функция воспринимает первый аргумент как входной
    //ioctlsocket(ListenSocket, FIONBIO, &mode); // Устанавливаем серверному сокету non blocking i/o
