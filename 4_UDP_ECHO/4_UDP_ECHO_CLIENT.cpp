...
void sendMessageToServer(SOCKET Socket)
{
    ...
    while (TRUE)
    {
        ...
        iResult = sendto(Socket, (const char*)msg, strlen(msg), 0, (SOCKADDR*)&SocketAddress, sizeof(SocketAddress));
        if (iResult < 0) {
...
int __cdecl main(int argc, char** argv)
{
    ...
    std::thread thread_send(sendMessageToServer, Socket);
