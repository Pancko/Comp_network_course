...
//
//static int serverFunc(sockaddr_in ClientSocket) // Получает и печатает информацию
//{
//    const char* message = "LITERALLY 1984";
//    while (TRUE)
//    {
//        int size_ClientSocket = sizeof(ClientSocket);
//        sendto(Socket, message, strlen(message), 0, (struct sockaddr*)&ClientSocket, size_ClientSocket);
//        Sleep(1000);
//    }
//}
//
...
//        if (bytesReceived > 0) {
//            std::thread thread(serverFunc, ClientAddress);
//            thread.detach();
//        }
//    }
//
